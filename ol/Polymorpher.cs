...
public static class Polymorpher
{
    ...
    private static void CopyValues(IValues values, IType[] genericTypes, List<string> generics, IValues copy)
    {
    ...
    {
        var copy = CopyAst(values);
        CopyValues(values, genericTypes, generics, copy);
    ...
    private static CompilerDirectiveAst CopyCompilerDirective(CompilerDirectiveAst compilerDirective, IType[] genericTypes, List<string> generics)
    {
        ...
        copy.StringValue = compilerDirective.StringValue;
        return copy;
    }
