...
public unsafe partial struct LLVMValueRef(IntPtr handle) : IEquatable<LLVMValueRef>
{
    ...
    public static LLVMValueRef CreateConstIntOfArbitraryPrecision(LLVMTypeRef IntTy, nuint[] Words) => CreateConstIntOfArbitraryPrecision(IntTy, Words.AsSpan());

    public static LLVMValueRef CreateConstIntOfArbitraryPrecision(LLVMTypeRef IntTy, ReadOnlySpan<nuint> Words)
    {
        fixed (nuint* pWords = Words)
        {
